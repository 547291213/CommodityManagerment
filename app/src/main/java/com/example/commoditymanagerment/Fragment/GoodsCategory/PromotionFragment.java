...
public class PromotionFragment extends CategoryFragment {

    @BindView(R.id.glv_promotionGoodsList)
    ...
    //当前商品种类
    private static final int PROMOTION_CATEGORY = 2;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.fg_category_promotion, container, false);
        mContext = getContext();
    ...
    private void initData() {
        ...
        glvPromotionGoodsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        glvPromotionGoodsList.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                int lastItemPosition = glvPromotionGoodsList.getLastVisiblePosition();
                    ...
                    if ((nextPage - 1) * Integer.valueOf(ROW_COUNT) < totalCount) {
                        ...
                        new Thread(new Runnable() {
                            public void run() {
                                try {
                                    Thread.sleep(2000);
                                    getData(PROMOTION_CATEGORY, nextPage);
    ...
    private static class MyHandler extends Handler {
        ...
        private WeakReference<PromotionFragment> weakReference;

        public MyHandler(PromotionFragment PromotionFragment) {
            weakReference = new WeakReference<>(PromotionFragment);

        }

        @Override
        public void handleMessage(Message msg) {
            PromotionFragment fragment = weakReference.get();
            if (fragment == null) {
                return;
            }
            ...
            switch (msg.what) {
                case 0:
                    ...
                    fragment.glvPromotionGoodsList.setFooterViewHide((fragment.nextPage - 1) * Integer.valueOf(ROW_COUNT) + 1);
