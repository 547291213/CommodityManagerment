...
public class NewProductFragment extends CategoryFragment {


    @BindView(R.id.glv_newGoodsList)
    GoodsListView glvNewGoodsList;
    ...
    //当前商品种类
    private static final int NEW_CATEGORY = 1;
...
//    private int scrollerState = SCROLL_STATE_IDLE;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.fg_category_newproduct, container, false);
        mContext = getContext();
    ...
    private void initData() {
        ...
        glvNewGoodsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        glvNewGoodsList.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                int lastItemPosition = glvNewGoodsList.getLastVisiblePosition();
                ...
                if ((lastItemPosition + 1) == totalItemCount && loadFinish == true) {
                    ...
                    if ((nextPage - 1) * Integer.valueOf(ROW_COUNT) < totalCount) {
                        ...
                        if (refreshDataByActivity != true){
                            glvNewGoodsList.setFooterViewShow();
                        }
                        new Thread(new Runnable() {
                            public void run() {
                                try {
                                    Thread.sleep(2000);
                                    getData(NEW_CATEGORY, nextPage);
    ...
    private static class MyHandler extends Handler {
        ...
        private WeakReference<NewProductFragment> weakReference;

        public MyHandler(NewProductFragment hotFragment) {
        ...
        public void handleMessage(Message msg) {
            NewProductFragment fragment = weakReference.get();
            if (fragment == null) {
                return;
            }
            ...
            switch (msg.what) {
                case 0:
                    ...
                    fragment.glvNewGoodsList.setFooterViewHide((fragment.nextPage - 1) * Integer.valueOf(ROW_COUNT) + 1);
                    ...
                    if (fragment.refreshDataByActivity) {
                        ...
                        //发送广播通知刷新
                        RxBus.getInstance().post(new RefreshMsg(NEW_CATEGORY));
...
//            initData();
    ...
    public void refreshData() {
        ...
        if (glvNewGoodsList != null) {
            glvNewGoodsList.setFooterViewHide(0);
        }
